		    ...
		    <div class="text-center mb-5 text-dark">Made with bootstrap</div>
		      <div class="card my-5">
			      <form class="card-body cardbody-color p-lg-5" method="post">
				      ...
				      <div class="mb-3">
					      <input type="text" class="form-control" id="name" aria-describedby="emailHelp" placeholder="User Name" name="name">
				      </div>
				      <div class="mb-3">
				      ...
				      <div id="emailHelp"
				           class="form-text text-center mb-5 text-dark">Not Registered?
